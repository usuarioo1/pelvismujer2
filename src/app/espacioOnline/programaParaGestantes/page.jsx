            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-8">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex-shrink-0">
                                        <div className="w-10 h-10 rounded-full bg-[#ED4137]/20 flex items-center justify-center">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-3 space-y-2 text-sm text-[#4E2226] bg-[#EDD0B2]/20 p-4 rounded-lg">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex-shrink-0">
                                        <div className="w-10 h-10 rounded-full bg-[#EDD0B2]/30 flex items-center justify-center">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex-shrink-0">
                                        <div className="w-10 h-10 rounded-full bg-[#4E2226]/20 flex items-center justify-center">
                                            <span className="text-2xl">🎶</span>
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-3 text-sm text-[#4E2226] bg-[#EDD0B2]/20 p-4 rounded-lg">
                        ...
                        <div className="bg-[#EDD0B2]/30 border-l-4 border-[#ED4137] p-6 rounded-lg mb-8">
                            <p className="text-[#2D2D2D] leading-relaxed">
                        ...
                        <div className="flex justify-center">
                            <button className="bg-gradient-to-r from-[#ED4137] to-[#E22727] text-white px-8 py-4 rounded-full font-semibold text-lg hover:shadow-lg hover:scale-105 transition-all duration-300">
                                Unirme al programa
                            </button>
                        </div>
                    </div>
