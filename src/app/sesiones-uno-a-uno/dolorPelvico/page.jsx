      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8 space-y-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">En nuestras sesiones trabajaremos:</h2>
            ...
            <div className="bg-rose-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Este espacio es para ti si deseas:</h3>
            ...
            <div className="bg-gradient-to-r from-rose-50 to-pink-50 rounded-xl p-6 space-y-3">
            ...
            {/* CTA Button */}
            <div className="pt-4">
              <button className="w-full bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold py-4 px-8 rounded-xl hover:from-rose-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-xl">
                Agendar Sesión
              </button>
            </div>
          </div>
