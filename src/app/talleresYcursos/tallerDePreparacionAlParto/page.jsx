                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-[#2D2D2D] leading-relaxed mt-4">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            <div className="bg-[#4E2226]/10 rounded-lg p-4">
                                <p className="text-sm text-[#4E2226] font-semibold mb-1">Duración</p>
                                <p className="text-[#2D2D2D] font-medium">3 horas</p>
                            </div>
                            <div className="bg-[#EDD0B2]/30 rounded-lg p-4">
                                <p className="text-sm text-[#4E2226] font-semibold mb-1">Modalidad</p>
                                <p className="text-[#2D2D2D] font-medium">Presencial y personalizado</p>
                                <p className="text-sm text-[#2D2D2D]/70 mt-1">Puedes asistir con tu acompañante</p>
                            </div>
                        </div>

                        {/* En este taller descubrirás */}
                        <div>
                            <h2 className="text-2xl font-bold text-[#4E2226] mb-4">En este taller descubrirás:</h2>
                                ...
                                {[
                                    ...
                                    <div key={index} className="flex gap-3">
                                        <div className="flex-shrink-0 mt-1">
                                            <svg className="w-5 h-5 text-[#ED4137]" fill="currentColor" viewBox="0 0 20 20">
                                                <path
                                                    fillRule="evenodd"
                                        ...
                                        <div>
                                            <p className="font-semibold text-[#4E2226]">{item.title}:</p>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold text-[#4E2226] mb-4">Este taller es para ti si deseas:</h2>
                            <div className="grid md:grid-cols-2 gap-3">
                                {[
                                    ...
                                    <div key={index} className="flex gap-2 items-start">
                                        <span className="text-[#ED4137] flex-shrink-0">✓</span>
                                        <p className="text-[#2D2D2D]">{item}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        {/* CTA */}
                        <div className="pt-4">
                            <button className="w-full bg-gradient-to-r from-[#ED4137] to-[#E22727] text-white font-semibold py-4 px-6 rounded-lg hover:from-[#E22727] hover:to-[#E22727] transition-all duration-300 shadow-lg hover:shadow-xl">
