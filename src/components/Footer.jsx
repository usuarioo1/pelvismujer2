            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="flex flex-col">
                        <h3 className="text-lg font-light tracking-wide text-gray-900 mb-4">PelvisMujer</h3>
                    ...
                    {/* Navigation Links */}
                    <div className="flex flex-col">
                        <h4 className="text-sm font-semibold text-gray-900 mb-4 tracking-wide">Navegación</h4>
                    ...
                    {/* Social Media */}
                    <div className="flex flex-col">
                        <h4 className="text-sm font-semibold text-gray-900 mb-4 tracking-wide">Síguenos</h4>
                    ...
                    {/* Payment Methods */}
                    <div className="flex flex-col">
                        <h4 className="text-sm font-semibold text-gray-900 mb-4 tracking-wide">Métodos de Pago</h4>
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm text-gray-600 font-light">Mercado Pago</span>
                        </div>
                    </div>
                </div>
            </div>
